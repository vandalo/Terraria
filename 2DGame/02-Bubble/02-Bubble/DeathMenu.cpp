...
void DeathMenu::update(int deltaTime)
{
...
void DeathMenu::renderBackground(){
...
void DeathMenu::initBackground(){

	//carreguem textura (el background bo es el 23)
	background.loadFromFile("images/BakcgroundDeath.png", TEXTURE_PIXEL_FORMAT_RGBA);
